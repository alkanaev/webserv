...
/*   Updated: 2022/04/12 17:27:36 by alkanaev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Configurations::work(std::string file) 
{
	...
	if (error_found() == 1) 
		std::cout << "[💥] The configuration file is " << RED "not accepted !!!" << EOC;
	else 
		std::cout << " [☀️ ] The configuration file is " << CYAN << "accepted !" << EOC;
}
